...
export default function Home() {
  return (
    <main className="flex flex-1 flex-col">
      ...
      <section className="mx-auto w-full max-w-[1200px] px-6 py-32">
        ...
        <div className="flex flex-col gap-20">
          ...
          <div data-reveal className="grid gap-8 md:grid-cols-2">
            ...
            <p className="max-w-[65ch] text-lg leading-[1.6] text-papier-gedaempft">
              Technical mentoring, pair programming, onboarding, code
              reviews. Plus a genAI hackathon in Munich I&apos;m organizing
              to pull whole teams up the AI curve.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* Where the proof is — one stat carries the brass (D-29) */}
      <section className="mx-auto w-full max-w-[1200px] px-6 py-32">
        <div data-reveal>
          <Eyebrow as="h2">Where the proof is</Eyebrow>
        </div>
        <div className="grid items-center gap-12 md:grid-cols-2">
          ...
          >
            ...
            <li>
              ...
              selected from{" "}
              <span className="text-messing">650+ applicants</span>, in
              progress
            </li>
            <li>2nd place &amp; Community Prize, iHack.Ruhr 2018</li>
          </ul>
        </div>
        <div
          data-reveal
